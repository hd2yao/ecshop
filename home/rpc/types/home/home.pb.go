...
type HomeFeedReq struct {
	...
	NeedDetail    bool                   `protobuf:"varint,6,opt,name=need_detail,json=needDetail,proto3" json:"need_detail,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HomeFeedReq) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *HomeFeedReq) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *HomeFeedReq) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *HomeFeedReq) GetNeedDetail() bool {
	if x != nil {
		return x.NeedDetail
	}
	return false
...
func (x *HomeFeedResp) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *HomeFeedResp) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
const file_rpc_home_proto_rawDesc = "" +
	...
	"\frecipes_list\x18\x04 \x03(\v2\x11.home.RecipesInfoR\vrecipesList\"\xb3\x01\n" +
	...
	"\vneed_detail\x18\x06 \x01(\bR\n" +
	"needDetail\"\xc8\x01\n" +
	"\fHomeFeedResp\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12!\n" +
	"\ffeed_version\x18\x03 \x01(\tR\vfeedVersion\x124\n" +
	"\frecipes_list\x18\x04 \x03(\v2\x11.home.RecipesInfoR\vrecipesList\x12\x16\n" +
	"\x06cursor\x18\x05 \x01(\tR\x06cursor\x12\x19\n" +
	"\bhas_more\x18\x06 \x01(\bR\ahasMore2\x8a\x01\n" +
	"\x04Home\x12L\n" +
